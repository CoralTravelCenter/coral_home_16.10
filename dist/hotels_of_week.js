import{i as o,s as a}from"./utils.js";function d(){return`<button class="custom-slider-nav-btn slider-bnt-next">
	<svg xmlns="http://www.w3.org/2000/svg" width="6" height="9" viewBox="0 0 6 9" fill="none">
		<path d="M1.25 1.16504L4.58333 4.49837L1.25 7.83171" stroke="#535353" stroke-linejoin="round"/>
	</svg>
</button>`}function g(){return`<button class="custom-slider-nav-btn slider-bnt-prev">
	<svg xmlns="http://www.w3.org/2000/svg" width="5" height="9" viewBox="0 0 5 9" fill="none">
		<path d="M4.58325 1.16504L1.24992 4.49837L4.58325 7.83171" stroke="#535353" stroke-linejoin="round"/>
	</svg>
</button>`}function c(){const i=window.hotels_of_week,e=document.querySelector("[data-hotels-week-slider]");function r(t){return`<svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`.repeat(t)}const l=i.map(t=>`
		...
		<ellipse cx="8" cy="5.66663" rx="2" ry="2" stroke="#535353" stroke-width="0.7" stroke-linejoin="round"/>
			...
			`).join("");o("afterbegin",l,e),o("afterend",d(),e),o("beforebegin",g(),e);const n=a("section.hotels-week");n.breakpoints={allowTouchMove:!0,769:{allowTouchMove:!1}},Object.assign(e,n),e.initialize(),[...document.querySelectorAll("section.hotels-week #narrow-tooltip-toggler")].forEach((t,s)=>new Tooltip(t,{erid:i[s].erid,vendor:"coral"}))}window.location.origin.includes("backoffice")||c();
